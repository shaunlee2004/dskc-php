...
<div class="kohana">
	...
	<table class="profiler">
		<tr class="group">
			<th class="name" rowspan="2"><?php echo __t(ucfirst($group)) ?></th>
		...
		<tr class="headers">
			<th class="name"><?php echo __t('Benchmark') ?></th>
			<?php foreach ($group_cols as $key): ?>
			<th class="<?php echo $key ?>"><?php echo __t(ucfirst($key)) ?></th>
			<?php endforeach ?>
		</tr>
	...
	<table class="profiler">
		...
		<tr class="final mark time">
			<th class="name" rowspan="2" scope="rowgroup"><?php echo __t('Application Execution').' ('.$stats['count'].')' ?></th>
