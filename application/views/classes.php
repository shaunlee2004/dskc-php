<div class="title">Dominion Shotokan Karate Club, LLC offers classes at
	two locations:</div>
<table class="topAligned">
	<tr>
		<td>Bailey's Community Center<br /> 5920 Summers Lane<br> Falls
			Church, VA 22041<br> (703) 931-7027<br /> <br /> <a
			href="https://maps.google.com/maps?q=5920+Summers+Lane+Falls+Church,+VA+2204">
				<?php echo HTML::image ( "/media/img/googleMaps.jpg" )?>
			</a>
		</td>
		...
		<td>
			<?php
			echo HTML::image ( "/media/img/Baileys_CC-cropped-268x97.jpg", array (
					'width' => 268,
					'height' => 97 
			) )?>
	...
	<tr>
		<td>James Lee Community Center<br> 2855-A Annandale Road<br> Falls
			...
			href="https://maps.google.com/maps?q=James+Lee+Community+Center+2855-A+Annandale+Road+Falls+Church,+VA+22042">
				<?php echo HTML::image ( "/media/img/googleMaps.jpg" )?>
			</a>
		</td>
		<td>Tuesday and Thursday<br>4:00 pm to 6:00 pm (children)<br>6:00 pm
			...
			from East Falls Church<br>Station (Orange Line); <a
			href="http://www.wmata.com/bus/timetables/va/03.pdf">3A-Annandale bus</a><br>stops
			right at facility.<br /></td>
		<td>
			<?php
			echo HTML::image ( "/media//img/2009_08_13_002-254x124.jpg", array (
					'width' => 254,
					'height' => 124 
			) )?>
					</td>
